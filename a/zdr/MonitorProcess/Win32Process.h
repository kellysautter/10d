...
public:
   ...
   bool GetProcessStatus( CString *strProcName, bool *bStatus );
   bool Init( );
   Win32Process( );
...
protected:
   ...
   bool m_bActive;
   bool FindProcesses95( CString *strProcessName, bool );
   bool FindProcessesNT( CString *strProcessName, bool );
   HMODULE m_hWin95Kernel;
   PFN_PROCESS32NEXT m_pfnProcess32Next;
   PFN_PROCESS32FIRST m_pfnProcess32First;
   PFN_CREATETHELP32SNPSHT m_pfnCreateToolhelp32Snapshot;
