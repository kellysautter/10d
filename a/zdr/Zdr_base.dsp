...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "$(KZD):\$(KZV)\w\incz" /I "$(KZD):\$(KZV)\w\incr" /I "$(KZD):\$(KZV)\a\incz" /I "$(KZD):\$(KZV)\a\incr" /D "_AFXDLL" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__WIN32__" /YX"stdafx.h" /FD /c
...
# ADD LINK32 Release\ZDrApp.lib Release\ZdCtl.lib ZDrApp.lib kzoengaa.lib /nologo /subsystem:windows /machine:I386 /out:"..\..\w\bin\ZDr.exe" /libpath:"$(KZD):\$(KZV)\w\libz" /libpath:"$(KZD):\$(KZV)\w\libr"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(KZD):\$(KZV)\w\incz" /I "$(KZD):\$(KZV)\w\incr" /I "$(KZD):\$(KZV)\a\incz" /I "$(KZD):\$(KZV)\a\incr" /D "_AFXDLL" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__WIN32__" /FR /YX"stdafx.h" /FD /c
...
# ADD LINK32 ZDrApp.lib kzoengaa.lib /nologo /subsystem:windows /debug /machine:I386 /out:"..\..\w\bin\ZDr.exe" /libpath:"$(KZD):\$(KZV)\w\libz" /libpath:"$(KZD):\$(KZV)\w\libr"
