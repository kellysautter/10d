...
# ADD LINK32 ZDrApp.lib kzoengaa.lib /nologo /subsystem:windows /dll /machine:I386 /out:"$(KZD):\$(KZV)\w\bin\ZdCtl.dll" /implib:"$(KZD):\$(KZV)\w\libr\ZdCtl.lib" /libpath:"$(KZD):\$(KZV)\w\libz" /libpath:"$(KZD):\$(KZV)\w\libr"
...
# ADD LINK32 ZDrApp.lib kzoengaa.lib jpeglib.lib msimg32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"$(KZD):\$(KZV)\w\bin\ZdCtl.dll" /implib:"$(KZD):\$(KZV)\w\libr\ZdCtl.lib" /libpath:"$(KZD):\$(KZV)\w\libz" /libpath:"$(KZD):\$(KZV)\w\libr"
# SUBTRACT LINK32 /pdb:none
