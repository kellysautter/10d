...
IMPLEMENT_DYNCREATE(ZCrystalEditView, CView)
...
{
   TRACE(_T("ZEditDropTargetImpl::OnDropEx - %x\n"), pWnd->m_hWnd);
   return DROPEFFECT_MOVE;
}
#endif
...
IMPLEMENT_DYNCREATE(ZCrystalTextBuffer, CCmdTarget)
