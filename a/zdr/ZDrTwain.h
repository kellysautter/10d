...
typedef zCHAR  TW_STR32[ 34 ],    FAR *pTW_STR32;
typedef zCHAR  TW_STR64[ 66 ],    FAR *pTW_STR64;
typedef zCHAR  TW_STR128[ 130 ],  FAR *pTW_STR128;
typedef zCHAR  TW_STR255[ 256 ],  FAR *pTW_STR255;

// Numeric types.
typedef zCHAR          TW_INT8,   FAR *pTW_INT8;
...
// DAT_IMAGEMEMXFER. Used to pass image data (e.g. in strips) from DS
// to application.
typedef struct
{
...
// DAT_SETUPMEMXFER. Sets up DS to application data transfer via a
// memory buffer.
typedef struct
{
...
#ifdef  _MSWIN_
  #ifdef _WIN32
     __declspec( dllexport ) TW_UINT16 FAR PASCAL
