...
// ****************************************************************************
    ...
    function scwShow(scwEle,scwSourceEle)
        {scwTriggerEle = scwSourceEle;
         ...
         if (document.getElementById('scw').style.visibility=='visible')
         {
            scwHide();
            return 0;
         }

         scwDateDisplayFormat = document.getElementById('zDateFormat').value;
         scwDateOutputFormat  = scwDateDisplayFormat;
      // alert( "Date Format: " + scwDateDisplayFormat );
