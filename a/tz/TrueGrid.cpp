...
zLONG ZGridColumn::PopulateListOfValues()
{
   ...
   if ( bListDomainOnly )
   {
      ...
      zSHORT nRC = GetFirstTableEntryForAttribute( pchBuffer, ulDisplayLth, vApp, strEntity, strAttr, strContext, &pvCursor );
      while ( nRC == 0 )
      {
         ...
         nRC = GetNextTableEntryForAttribute( pchBuffer, ulDisplayLth, vApp, strEntity, strAttr, strContext, &pvCursor );
      }
