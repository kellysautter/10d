...
LRESULT PASCAL EditCtrlWndProc(HWND hWnd, register UINT uMsg, register WPARAM wParam, register LPARAM lParam)
{
   ...
   switch ( uMsg )
   {
      ...
      HANDLE_MESSAGE( WM_COMMAND, OnCommand );
      HANDLE_MESSAGE( WM_NOTIFY, OnNotify );
      HANDLE_MESSAGE( WM_MOVE, OnMove );
      ...
      HANDLE_MESSAGE( WM_GETTEXTLENGTH, OnGetTextLength );
      HANDLE_MESSAGE( CMM_GETTEXTLENGTH, OnGetTextLength );
      HANDLE_MESSAGE( WM_GETTEXT, OnWMGetText );
      ...
      HANDLE_MESSAGE( CMM_SETCURRENTVIEW, OnSetCurrentView );
      ...
      HANDLE_MESSAGE( CMM_UPDATECONTROLPOSITIONS, OnUpdateControlPositions );
   }
