...
//
//  Original Copyright © 1997-2001 WinMain Software
//  Portions Copyright © 2000-2001 Nathan Lewis
//
...
#ifndef _CMCSAFX_H__INCLUDED_
#define _CMCSAFX_H__INCLUDED_


#include "CodeSense.h"

class CCodeSenseCtrl : public CWnd
{
   public:

   virtual BOOL CCodeSenseCtrl::Create( DWORD dwStyle, const CRect& rect, CWnd *pParentWnd, UINT nID )
         { return CWnd::Create( CODESENSEWNDCLASS, _T(""), dwStyle, rect, pParentWnd, nID, NULL ); }
   ...
   void UpdateControlPositions() const
      { ASSERT( ::IsWindow( m_hWnd ) ); CM_UpdateControlPositions( m_hWnd ); }
};


/////////////////////////////////////////////////////////////////////////////

#endif//#ifndef _CMCSAFX_H__INCLUDED_
