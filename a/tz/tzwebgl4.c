                      ...
                      zVIEW     vDialogDfltMenu )
{
   zVIEW     vWork = 0; 
   zSHORT    RESULT; 
   //:VIEW vDialogDfltT BASED ON LOD TZWDLGSO
   zVIEW     vDialogDfltT = 0; 
   ...
   //:STRING ( 1 )     szSideMenuOptions
   zCHAR     szSideMenuOptions[ 2 ] = { 0 }; 
   //:STRING ( 256 )   szClass
   zCHAR     szClass[ 257 ] = { 0 }; 
   //:STRING ( 256 )   szClass2
   ...
   //:END 
   //:szBootstrap5 = vWork.Root.Bootstrap5
   GetVariableFromAttribute( szBootstrap5, 0, 'S', 2, vWork, "Root", "Bootstrap5", "", 0 );
   ...
   { 
      ...
      { 
         //:// In Boostrap, if we have no option in the side menu (we have a side menu so it is consistent look with pages with a side menu but no
         //:// text in the option.
         //:IF vDialogMenu.Option EXISTS
         lTempInteger_1 = CheckExistenceOfEntity( vDialogMenu, "Option" );
         if ( lTempInteger_1 == 0 )
         { 
            //:szText = vDialogMenu.Option.Text
            GetVariableFromAttribute( szText, 0, 'S', 501, vDialogMenu, "Option", "Text", "", 0 );
            //:zRTrim( szText, szText, 500 )
            zRTrim( szText, szText, 500 );
            //:zLTrim( szText, szText, 500 )
            zLTrim( szText, szText, 500 );
   ...
   { 
      ...
      //:// In Boostrap, if we have no option in the side menu (we have a side menu so it is consistent look with pages with a side menu but no
      //:// text in the option.
      //:IF vDialogDfltMenu.DfltMenu  EXISTS
      lTempInteger_2 = CheckExistenceOfEntity( vDialogDfltMenu, "DfltMenu" );
      if ( lTempInteger_2 == 0 )
      { 
         //:CreateViewFromViewForTask( vDialogDfltT, vDialogDfltMenu, 0 )
         CreateViewFromViewForTask( &vDialogDfltT, vDialogDfltMenu, 0 );
         //:SET CURSOR FIRST vDialogDfltT.Menu WHERE vDialogDfltT.Menu.ZKey = vDialogDfltMenu.DfltMenu.ZKey
         GetIntegerFromAttribute( &lTempInteger_3, vDialogDfltMenu, "DfltMenu", "ZKey" );
         RESULT = SetCursorFirstEntityByInteger( vDialogDfltT, "Menu", "ZKey", lTempInteger_3, "" );
         //:IF vDialogDfltT.Option EXISTS
         lTempInteger_4 = CheckExistenceOfEntity( vDialogDfltT, "Option" );
         if ( lTempInteger_4 == 0 )
         { 
            //:szText = vDialogDfltT.Option.Text
            GetVariableFromAttribute( szText, 0, 'S', 501, vDialogDfltT, "Option", "Text", "", 0 );
            //:zRTrim( szText, szText, 500 )
            zRTrim( szText, szText, 500 );
            //:zLTrim( szText, szText, 500 )
            zLTrim( szText, szText, 500 );
   ...
   { 
      ...
      CreateViewFromViewForTask( &vDialogDfltT, vDialogDfltMenu, 0 );
      //:SET CURSOR FIRST vDialogDfltT.Menu WHERE vDialogDfltT.Menu.ZKey = vDialogDfltMenu.DfltMenu.ZKey
      GetIntegerFromAttribute( &lTempInteger_5, vDialogDfltMenu, "DfltMenu", "ZKey" );
      RESULT = SetCursorFirstEntityByInteger( vDialogDfltT, "Menu", "ZKey", lTempInteger_5, "" );
      //:FOR EACH vDialogDfltT.OptAct WITHIN vDialogDfltT.Menu
      RESULT = SetCursorFirstEntity( vDialogDfltT, "OptAct", "Menu" );
      ...
      { 
         ...
         { 
            //:szText = vDialogDfltT.Option.Text
            GetVariableFromAttribute( szText, 0, 'S', 501, vDialogDfltT, "Option", "Text", "", 0 );
            //:szTextID = vDialogDfltT.Option.LangID
            GetVariableFromAttribute( szTextID, 0, 'S', 257, vDialogDfltT, "Option", "LangID", "", 0 );
         ...
         { 
            //:szNavigationTitle = vDialogDfltT.Option.Text
            GetVariableFromAttribute( szNavigationTitle, 0, 'S', 501, vDialogDfltT, "Option", "Text", "", 0 );
         } 

         //:END
         //:szDialogName = vDialogDfltT.OptAct.DialogName
         GetVariableFromAttribute( szDialogName, 0, 'S', 51, vDialogDfltT, "OptAct", "DialogName", "", 0 );
         //:IF szDialogName = ""
         ...
         //:IF vDialogDfltT.OptAct EXISTS
         lTempInteger_6 = CheckExistenceOfEntity( vDialogDfltT, "OptAct" );
         if ( lTempInteger_6 == 0 )
         { 
            //:szActionName = "onclick=^" + vDialogDfltT.OptAct.Tag + "()^"
            GetVariableFromAttribute( szTempString_1, 0, 'S', 33, vDialogDfltT, "OptAct", "Tag", "", 0 );
            ...
            //:ActionType = vDialogDfltT.OptAct.Type
            GetIntegerFromAttribute( &ActionType, vDialogDfltT, "OptAct", "Type" );
            //:ELSE
         } 
         else
         { 
         ...
         //:szMenuName = vDialogDfltT.Option.Tag         
         GetVariableFromAttribute( szMenuName, 0, 'S', 51, vDialogDfltT, "Option", "Tag", "", 0 );
         ...
         //:IF vDialogDfltT.OptAct.WindowName = vDialog.Window.Tag
         if ( CompareAttributeToAttribute( vDialogDfltT, "OptAct", "WindowName", vDialog, "Window", "Tag" ) == 0 )
         { 
         ...
         //:IF vDialogDfltT.Option.CSS_Class != "" 
         if ( CompareAttributeToString( vDialogDfltT, "Option", "CSS_Class", "" ) != 0 )
         { 
            //:szClass = "class=^" + vDialogDfltT.Option.CSS_Class + "^"
            GetVariableFromAttribute( szTempString_2, 0, 'S', 255, vDialogDfltT, "Option", "CSS_Class", "", 0 );
            ZeidonStringCopy( szClass, 1, 0, "class=^", 1, 0, 257 );
         ...
         //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
         WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
         //:szOptionTag = vDialogDfltT.Option.Tag
         GetVariableFromAttribute( szOptionTag, 0, 'S', 51, vDialogDfltT, "Option", "Tag", "", 0 );
         //:szOptionTag = vDialogDfltT.Option.Tag
         GetVariableFromAttribute( szOptionTag, 0, 'S', 51, vDialogDfltT, "Option", "Tag", "", 0 );
         ...
         { 
            ...
            //:IF vDialogDfltT.Option.WebHTML5Attribute != ""
            if ( CompareAttributeToString( vDialogDfltT, "Option", "WebHTML5Attribute", "" ) != 0 )
            { 
               //:IF szBootstrap5 = "Y"
               if ( ZeidonStringCompare( szBootstrap5, 1, 0, "Y", 1, 0, 2 ) == 0 )
               { 
                  //:szText = "<i class=^align-middle me-2 fas fa-fw " + vDialogDfltT.Option.WebHTML5Attribute  + "^></i>"
                  GetVariableFromAttribute( szTempString_3, 0, 'S', 255, vDialogDfltT, "Option", "WebHTML5Attribute", "", 0 );
                  ZeidonStringCopy( szText, 1, 0, "<i class=^align-middle me-2 fas fa-fw ", 1, 0, 501 );
               ...
               { 
                  //:szText = "<i class=^align-middle mr-2 fas fa-fw " + vDialogDfltT.Option.WebHTML5Attribute  + "^></i>"
                  GetVariableFromAttribute( szTempString_4, 0, 'S', 255, vDialogDfltT, "Option", "WebHTML5Attribute", "", 0 );
                  ZeidonStringCopy( szText, 1, 0, "<i class=^align-middle mr-2 fas fa-fw ", 1, 0, 501 );
                  ZeidonStringConcat( szText, 1, 0, szTempString_4, 1, 0, 501 );
                  ZeidonStringConcat( szText, 1, 0, "^></i>", 1, 0, 501 );
               } 
         ...
         //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 1 )
         WL_QC( vDialog, lFile, szWriteBuffer, "^", 1 );
         RESULT = SetCursorNextEntity( vDialogDfltT, "OptAct", "Menu" );
      } 
   ...
   { 
      ...
      GetVariableFromAttribute( szTempString_5, 0, 'S', 255, vDialogMenu, "Dialog", "WEB_LeftSideInclude", "", 0 );
...
//    
//    /*
//    // KJS 02/15/22 - For bootstrap... we want to have the side menu visible only if there are menu options (as long as the window is greater than
//    IF szStyleIsBootstrap = "Y"
//       szWriteBuffer = "<script>"
//       WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
//       szWriteBuffer = "   if($(window).width() > 991.98 )"
//       WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
//       szWriteBuffer = "     $(^#sidebar^).addClass(^toggled^);"
//       WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
//       szWriteBuffer = "</script>"
//       WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
//    END
                ...
                zLONG     lTraceLevel )
{
   ...
   //:IF szNoMonitorTaskLogout = "" OR szNoMonitorTaskLogout = "N"
   //:   szWriteBuffer = "      String strLastTask = (String) request.getParameter( ^zLastTask^ );"
   //:   WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )

   //:   szWriteBuffer = "      if ( !taskId.equals(strLastTask) )"
   //:   WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
   //:   szWriteBuffer = "      {"
   //:   WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
   ...
   //:END
   //:// We set szWAB to indicate that we need to do "Next Window" processing.
   //:lActionType = vDialog.Action.Type
   GetIntegerFromAttribute( &lActionType, vDialog, "Action", "Type" );
   //:// KJS 06/02/23 - Adding exit zeidon task in here.
   //:IF lActionType = zWAB_ExitDialogTask      
   if ( lActionType == zWAB_ExitDialogTask )
   { 
      //:szWAB = "zWAB_ExitDialogTask"
      ZeidonStringCopy( szWAB, 1, 0, "zWAB_ExitDialogTask", 1, 0, 65 );
      //:ELSE
   } 
   else
   { 
   ...
   //:END // IF lActionType = zWAB_ExitDialogTask
   ...
   { 
      ...
      { 
         ...
         { 
            //://szActionName 
            //:szMsg = "A Control for the 'Download File' action " + szActionName + " could not be located. The action is not being used."
            ZeidonStringCopy( szMsg, 1, 0, "A Control for the 'Download File' action ", 1, 0, 201 );
            ZeidonStringConcat( szMsg, 1, 0, szActionName, 1, 0, 201 );
            ZeidonStringConcat( szMsg, 1, 0, " could not be located. The action is not being used.", 1, 0, 201 );
            //:MessageSend( vDialog, "", "Download File Generation", szMsg,
            //:                         zMSGQ_OBJECT_CONSTRAINT_ERROR, 0 )
            MessageSend( vDialog, "", "Download File Generation", szMsg, zMSGQ_OBJECT_CONSTRAINT_ERROR, 0 );
            //:ELSE
         } 
         else
         { 
            ...
            if ( lTempInteger_1 != 0 )
            { 
               //:szMsg = "The Control " + vDialogCtrl.Control.Tag + " with 'Download File' action " + szActionName + " must specify mapping for the source file name."
               GetVariableFromAttribute( szTempString_9, 0, 'S', 33, vDialogCtrl, "Control", "Tag", "", 0 );
               ZeidonStringCopy( szMsg, 1, 0, "The Control ", 1, 0, 201 );
               ZeidonStringConcat( szMsg, 1, 0, szTempString_9, 1, 0, 201 );
               ZeidonStringConcat( szMsg, 1, 0, " with 'Download File' action ", 1, 0, 201 );
               ZeidonStringConcat( szMsg, 1, 0, szActionName, 1, 0, 201 );
               ZeidonStringConcat( szMsg, 1, 0, " must specify mapping for the source file name.", 1, 0, 201 );
               //:MessageSend( vDialog, "", "Download File Generation", szMsg,
               //:                         zMSGQ_OBJECT_CONSTRAINT_ERROR, 0 )
               MessageSend( vDialog, "", "Download File Generation", szMsg, zMSGQ_OBJECT_CONSTRAINT_ERROR, 0 );
               //:ELSE
            ...
            { 
               //:// KJS 09/22/25 - duplicate view. I think this always has to be a registered view.
   ...
   { 
      ...
      //:   WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:   // KJS 08/31/20 - Give message if no file was selected.
      //:   szWriteBuffer = "      if ( iFileLth == -1 )"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "      if ( iFileLth == -1 )", 1, 0, 10001 );
      //:   WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:   szWriteBuffer = "      {"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "      {", 1, 0, 10001 );
      //:   WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:   szWriteBuffer = "         VmlOperation.CreateMessage( task, ^" + szCtrlTag + "^, ^No file was selected.^, ^No file was selected.^ );"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "         VmlOperation.CreateMessage( task, ^", 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, "^, ^No file was selected.^, ^No file was selected.^ );", 1, 0, 10001 );
      //:   WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:   szWriteBuffer = "         break;"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "         break;", 1, 0, 10001 );
      ...
      { 
         ...
         { 
            ...
            { 
               ...
               //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
               WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
               //:szWriteBuffer = "         if ( " + vDialogTemp.CtrlMapView.Name + ".cursor( ^" +
               //:                vDialogTemp.CtrlMapRelatedEntity.Name + "^ ).checkExistenceOfEntity( ).toInt() >= 0 )"
               ...
               GetVariableFromAttribute( szTempString_12, 0, 'S', 33, vDialogTemp, "CtrlMapRelatedEntity", "Name", "", 0 );
               ...
               { 
                  ...
                  GetVariableFromAttribute( szTempString_13, 0, 'S', 33, vDialogTemp, "CtrlMapView", "Name", "", 0 );
                  ZeidonStringCopy( szWriteBuffer, 1, 0, "               ", 1, 0, 10001 );
                  ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_13, 1, 0, 10001 );
                  ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
                  GetVariableFromAttribute( szTempString_14, 0, 'S', 33, vDialogTemp, "CtrlMapRelatedEntity", "Name", "", 0 );
                  ...
                  GetVariableFromAttribute( szTempString_15, 0, 'S', 33, vDialogTemp, "CtrlMapER_Attribute", "Name", "", 0 );
               ...
               { 
                  ...
                  //:       ".cursor( ^" + vDialogTemp.CtrlMapRelatedEntity.Name + "^ ).getAttribute( ^" +
                  //:       vDialogTemp.CtrlMapER_Attribute.Name + "^ ).setValue( strInputFileName, ^^ );"
                  GetVariableFromAttribute( szTempString_16, 0, 'S', 33, vDialogTemp, "CtrlMapView", "Name", "", 0 );
                  ZeidonStringCopy( szWriteBuffer, 1, 0, "               ", 1, 0, 10001 );
                  ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_16, 1, 0, 10001 );
                  ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
                  GetVariableFromAttribute( szTempString_17, 0, 'S', 33, vDialogTemp, "CtrlMapRelatedEntity", "Name", "", 0 );
                  ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_17, 1, 0, 10001 );
                  ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getAttribute( ^", 1, 0, 10001 );
                  GetVariableFromAttribute( szTempString_18, 0, 'S', 33, vDialogTemp, "CtrlMapER_Attribute", "Name", "", 0 );
      ...
      { 
         ...
         { 
            ...
            { 
               ...
               //:   // KJS 09/22/25 - Commenting out as TEST
               ...
               //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
               WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
               //:szWriteBuffer = "         if ( !" + szViewName + ".cursor( ^" + szEntityName + "^ ).setByEntityKey( lEKey ).isSet() )"
               ZeidonStringCopy( szWriteBuffer, 1, 0, "         if ( !", 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, szViewName, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, szEntityName, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).setByEntityKey( lEKey ).isSet() )", 1, 0, 10001 );
               //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
               WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
   ...
   { 
      ...
      { 
         ...
         GetVariableFromAttribute( szTempString_19, 0, 'S', 33, vDialog, "Dialog", "Tag", "", 0 );
         ...
         ZeidonStringConcat( szWriteBuffer, 1, 0, ".", 1, 0, 10001 );
         GetVariableFromAttribute( szTempString_20, 0, 'S', 33, vDialog, "ActOper", "Name", "", 0 );
      ...
      { 
         ...
         { 
            ...
            GetVariableFromAttribute( szTempString_21, 0, 'S', 33, vDialog, "Action", "DialogName", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_21, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^, ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_22, 0, 'S', 33, vDialog, "Action", "WindowName", "", 0 );
      ...
      { 
         ...
         //:    lActionType != zWAB_StartJasperPDF_Page AND lActionType != zWAB_StartJasperXLS_Page AND
         //:    lActionType != zWAB_ReportStreamInfo
         if ( lActionType != zWAB_StartBrowserHTML_Page && lActionType != zWAB_StartBrowserPDF_Page && lActionType != zWAB_StartJasperPDF_Page && lActionType != zWAB_StartJasperXLS_Page && lActionType != zWAB_ReportStreamInfo )
         { 
            ...
            //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
            WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
            //:szWriteBuffer = "      if ( vKZXMLPGO.cursor( ^NextDialogWindow^ ).checkExistenceOfEntity( ).toInt() >= 0 )"
            ZeidonStringCopy( szWriteBuffer, 1, 0, "      if ( vKZXMLPGO.cursor( ^NextDialogWindow^ ).checkExistenceOfEntity( ).toInt() >= 0 )", 1, 0, 10001 );
            //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
            WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
            //://szWriteBuffer = "      if ( nRC >= 0 )"
            //://WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
            ...
            //:ELSE  // IF  lActionType != zWAB_StartBrowserHTML_Page...
         } 
         else
         { 
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            GetVariableFromAttribute( szTempString_23, 0, 'S', 33, vDialogTemp, "ActMapLOD_Entity", "Name", "", 0 );
            ZeidonStringCopy( szScopingName, 1, 0, "^", 1, 0, 101 );
            ZeidonStringConcat( szScopingName, 1, 0, szTempString_23, 1, 0, 101 );
         ...
         //:   // KJS 09/22/25 - added the task.getViewByName at the top of the jsp
         ...
         GetVariableFromAttribute( szTempString_24, 0, 'S', 33, vDialog, "Action", "Tag", "", 0 );
         ZeidonStringCopy( szWriteBuffer, 1, 0, "         VmlOperation.CreateMessage( task, ^", 1, 0, 10001 );
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            GetVariableFromAttribute( szTempString_25, 0, 'S', 33, vDialog, "Action", "DialogName", "", 0 );
            ...
            GetVariableFromAttribute( szTempString_26, 0, 'S', 33, vDialog, "Action", "WindowName", "", 0 );
      ...
      { 
         ...
         GetVariableFromAttribute( szTempString_27, 0, 'S', 33, vDialogRoot, "Dialog", "Tag", "", 0 );
         ZeidonStringCopy( szWriteBuffer, 1, 0, "      strURL = response.encodeRedirectURL( ^", 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_27, 1, 0, 10001 );
         GetVariableFromAttribute( szTempString_28, 0, 'S', 33, vDialogRoot, "Window", "Tag", "", 0 );
      ...
      if ( lActionType == zWAB_ExitDialogTask )
      { 
         //:IF vDialog.Action.DialogName != "" AND vDialog.Action.WindowName != ""  
         if ( CompareAttributeToString( vDialog, "Action", "DialogName", "" ) != 0 && CompareAttributeToString( vDialog, "Action", "WindowName", "" ) != 0 )
         { 
            //:szWriteBuffer = "      if ( strURL.equals( ^^ ) )"
            ...
            //:szWriteBuffer = "         strURL = response.encodeRedirectURL( ^" +
            //:             vDialog.Action.DialogName + vDialog.Action.WindowName + ".jsp^ );"
            GetVariableFromAttribute( szTempString_29, 0, 'S', 33, vDialog, "Action", "DialogName", "", 0 );
            ZeidonStringCopy( szWriteBuffer, 1, 0, "         strURL = response.encodeRedirectURL( ^", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_29, 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_30, 0, 'S', 33, vDialog, "Action", "WindowName", "", 0 );
      ...
      { 
         ...
         //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
         WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
         //:szWriteBuffer = "      if ( vKZXMLPGO.cursor( ^PagePath^ ).checkExistenceOfEntity( ).toInt() >= 0 )"
         ZeidonStringCopy( szWriteBuffer, 1, 0, "      if ( vKZXMLPGO.cursor( ^PagePath^ ).checkExistenceOfEntity( ).toInt() >= 0 )", 1, 0, 10001 );
         //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
         WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
         //://szWriteBuffer = "      if ( nRC >= 0 )"
         //://WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
            WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
            //:szWriteBuffer = "         if ( " + vDialogCtrl.CtrlMapView.Name + ".cursor( ^" +
            //:                                    vDialogCtrl.CtrlMapRelatedEntity.Name + "^ ).checkExistenceOfEntity( ).toInt() >= 0 )"
            ...
            ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_35, 0, 'S', 33, vDialogCtrl, "CtrlMapRelatedEntity", "Name", "", 0 );
            ...
            GetVariableFromAttribute( szTempString_36, 0, 'S', 33, vDialogCtrl, "CtrlMapView", "Name", "", 0 );
            ZeidonStringCopy( szWriteBuffer, 1, 0, "            sDownloadFile = ", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_36, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_37, 0, 'S', 33, vDialogCtrl, "CtrlMapRelatedEntity", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_37, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getAttribute( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_38, 0, 'S', 33, vDialogCtrl, "CtrlMapER_Attribute", "Name", "", 0 );
            ...
            GetVariableFromAttribute( szTempString_39, 0, 'S', 33, vDialogCtrl, "CtrlMapView", "Name", "", 0 );
            ZeidonStringCopy( szWriteBuffer, 1, 0, "            ", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_39, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_40, 0, 'S', 33, vDialogCtrl, "CtrlMapRelatedEntity", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_40, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getAttribute( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_41, 0, 'S', 33, vDialogCtrl, "CtrlMapER_Attribute", "Name", "", 0 );
            ...
            { 
               ...
               GetVariableFromAttribute( szTempString_43, 0, 'S', 33, vDialogCtrl, "CtrlMapView", "Name", "", 0 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_43, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, ".", 1, 0, 10001 );
               GetVariableFromAttribute( szTempString_44, 0, 'S', 33, vDialogCtrl, "CtrlMapRelatedEntity", "Name", "", 0 );
            ...
            { 
               ...
               GetVariableFromAttribute( szTempString_46, 0, 'S', 33, vDialogCtrl, "CtrlMapView", "Name", "", 0 );
            ...
            WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
            //:szWriteBuffer = "         strURL = response.encodeRedirectURL( ^" + vDialogRoot.Dialog.Tag + vDialogRoot.Window.Tag + ".jsp^ );"
            GetVariableFromAttribute( szTempString_47, 0, 'S', 33, vDialogRoot, "Dialog", "Tag", "", 0 );
            ZeidonStringCopy( szWriteBuffer, 1, 0, "         strURL = response.encodeRedirectURL( ^", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_47, 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_48, 0, 'S', 33, vDialogRoot, "Window", "Tag", "", 0 );
   ...
   { 
      ...
      //:szWriteBuffer = "               exporter.setExporterInput(new SimpleExporterInput(jasperPrint));"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "               exporter.setExporterInput(new SimpleExporterInput(jasperPrint));", 1, 0, 10001 );
      //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      ...
      //:szWriteBuffer = "               exporter.setExporterOutput(new SimpleOutputStreamExporterOutput(strDirFileName));"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "               exporter.setExporterOutput(new SimpleOutputStreamExporterOutput(strDirFileName));", 1, 0, 10001 );
      //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )                     
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      ...
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:szWriteBuffer = "            strVMLError = ^<br><br>*** Error running Operation " + vDialog.Action.Tag + ": ^ + e.getMessage();"
      GetVariableFromAttribute( szTempString_52, 0, 'S', 33, vDialog, "Action", "Tag", "", 0 );
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            strVMLError = ^<br><br>*** Error running Operation ", 1, 0, 10001 );
   ...
   //:// KJS 09/17/14 - Run a jasper report and open in PDF.
   //:IF lActionType = zWAB_ReportStreamInfo
   if ( lActionType == zWAB_ReportStreamInfo )
   { 
      //:szWriteBuffer = "         try"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "         try", 1, 0, 10001 );
      ...
      //:// (otherwise we would need to have a data type JasperPrint in VML), so I am going to assume that we will look for an
      //:// operation in ZGLOBAL1 and that the operation we are looking for has the same name as the Action name.
      //:szWriteBuffer = "            // The file name, content type and a byte array containing the report are encapsulated in a"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            // The file name, content type and a byte array containing the report are encapsulated in a", 1, 0, 10001 );
      //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:szWriteBuffer = "            // ReportStreamInfo object returned from a ZGLOBAL1 method that has the same name as the window action."
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            // ReportStreamInfo object returned from a ZGLOBAL1 method that has the same name as the window action.", 1, 0, 10001 );
      //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:szWriteBuffer = "            ZGLOBAL1_Operation m_ZGLOBAL1_Operation = new ZGLOBAL1_Operation( vKZXMLPGO );"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            ZGLOBAL1_Operation m_ZGLOBAL1_Operation = new ZGLOBAL1_Operation( vKZXMLPGO );", 1, 0, 10001 );
      //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:szWriteBuffer = "            ReportStreamInfo report_info = m_ZGLOBAL1_Operation." + vDialog.Action.Tag +
      //:                "( new zVIEW( vKZXMLPGO ));"
      GetVariableFromAttribute( szTempString_53, 0, 'S', 33, vDialog, "Action", "Tag", "", 0 );
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            ReportStreamInfo report_info = m_ZGLOBAL1_Operation.", 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_53, 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, "( new zVIEW( vKZXMLPGO ));", 1, 0, 10001 );
      //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 1 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 1 );
      //:szWriteBuffer = "            response.setContentType(report_info.getContentType());"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            response.setContentType(report_info.getContentType());", 1, 0, 10001 );
      //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:szWriteBuffer = "            response.setContentLength(report_info.getFileLength());"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            response.setContentLength(report_info.getFileLength());", 1, 0, 10001 );
      //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:szWriteBuffer = "            response.setHeader(^Content-disposition^, report_info.getContentDisposition());"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            response.setHeader(^Content-disposition^, report_info.getContentDisposition());", 1, 0, 10001 );
      //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:szWriteBuffer = "            response.getOutputStream().write(report_info.getFile());"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            response.getOutputStream().write(report_info.getFile());", 1, 0, 10001 );
      //:WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      ...
      WL_QC( vDialogRoot, lFile, szWriteBuffer, "^", 0 );
      //:szWriteBuffer = "            strVMLError = ^<br><br>*** Error running Operation " + vDialog.Action.Tag + ": ^ + e.getMessage();"
      GetVariableFromAttribute( szTempString_54, 0, 'S', 33, vDialog, "Action", "Tag", "", 0 );
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            strVMLError = ^<br><br>*** Error running Operation ", 1, 0, 10001 );
                              ...
                              zLONG     lOffsetY )
{
   ...
   //:   
   //:   // KJS 09/01/20 - We are going to look at the UsesDateFormatFromDB for the moment to determine if the file upload max length comes
   //:   // from the database.
   //:   szDateFormatDBFlag = ""
   ZeidonStringCopy( szDateFormatDBFlag, 1, 0, "", 1, 0, 2 );
   //:   GetViewByName( vLPLR, "TaskLPLR", vDialog, zLEVEL_TASK )
   GetViewByName( &vLPLR, "TaskLPLR", vDialog, zLEVEL_TASK );
   //:   szSystemIniApplName = "[App." + vLPLR.LPLR.Name + "]"
   GetVariableFromAttribute( szTempString_2, 0, 'S', 33, vLPLR, "LPLR", "Name", "", 0 );
   ZeidonStringCopy( szSystemIniApplName, 1, 0, "[App.", 1, 0, 65 );
   ZeidonStringConcat( szSystemIniApplName, 1, 0, szTempString_2, 1, 0, 65 );
   ZeidonStringConcat( szSystemIniApplName, 1, 0, "]", 1, 0, 65 );
   ...
   { 
      ...
      //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
      //:   szWriteBuffer = "      strErrorMapValue = ^10485760^;"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "      strErrorMapValue = ^10485760^;", 1, 0, 10001 );
      //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );

      //:   szWriteBuffer = "      View sHostT = task.getViewByName( ^sHost^ );"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "      View sHostT = task.getViewByName( ^sHost^ );", 1, 0, 10001 );
      //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
      //:   szWriteBuffer = "      if ( VmlOperation.isValid( sHostT ) )"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "      if ( VmlOperation.isValid( sHostT ) )", 1, 0, 10001 );
      //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
      //:   szWriteBuffer = "      {"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "      {", 1, 0, 10001 );
      //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
      //:   szWriteBuffer = "         if ( sHostT.cursor( ^Host^ ).checkExistenceOfEntity( ).toInt() >= 0 )"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "         if ( sHostT.cursor( ^Host^ ).checkExistenceOfEntity( ).toInt() >= 0 )", 1, 0, 10001 );
      //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
      //:   //szWriteBuffer = "         if ( nRC >= 0 )"
      //:   //WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
      //:   szWriteBuffer = "            strErrorMapValue = sHostT.cursor(^Host^).getAttribute( ^UploadFileSizeMax^ ).getString( );"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "            strErrorMapValue = sHostT.cursor(^Host^).getAttribute( ^UploadFileSizeMax^ ).getString( );", 1, 0, 10001 );
      //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
      ...
      //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
      //:   szWriteBuffer = "   <input name=^zFileSize^ id=^zFileSize^ type=^hidden^ value=^<%=strErrorMapValue%>^ >"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "   <input name=^zFileSize^ id=^zFileSize^ type=^hidden^ value=^<%=strErrorMapValue%>^ >", 1, 0, 10001 );
      //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
   } 
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            //:   szWriteBuffer = "      if ( " + vDialogTemp.CtrlMapView.Name + ".cursor( ^" +
            //:                   vDialogTemp.CtrlMapRelatedEntity.Name + "^ ).checkExistenceOfEntity( ).toInt() >= 0 )"
            GetVariableFromAttribute( szTempString_6, 0, 'S', 33, vDialogTemp, "CtrlMapView", "Name", "", 0 );
            ZeidonStringCopy( szWriteBuffer, 1, 0, "      if ( ", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_6, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_7, 0, 'S', 33, vDialogTemp, "CtrlMapRelatedEntity", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_7, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).checkExistenceOfEntity( ).toInt() >= 0 )", 1, 0, 10001 );
            //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
            WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
            ...
            GetVariableFromAttribute( szTempString_8, 0, 'S', 33, vDialogTemp, "CtrlMapView", "Name", "", 0 );
            ZeidonStringCopy( szWriteBuffer, 1, 0, "         strErrorMapValue = ", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_8, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor(^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_9, 0, 'S', 33, vDialogTemp, "CtrlMapRelatedEntity", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_9, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^).getAttribute( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_10, 0, 'S', 33, vDialogTemp, "CtrlMapER_Attribute", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_10, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getString( ^^ );", 1, 0, 10001 );
            //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
            WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
            ...
            { 
               ...
               GetVariableFromAttribute( szTempString_11, 0, 'S', 33, vDialogTemp, "Control", "Tag", "", 0 );
   ...
   //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 )
   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 0 );
   //:   // KJS 07/29/20 - Generate hidden field for in case user wants the uploaded file to have a different name when uploaded.
   //:   szWriteBuffer = "   <input name=^zNewFileName^ id=^zNewFileName^ type=^hidden^ value=^<%=vKZXMLPGO.cursor(^Session^).getAttribute(^PrintFileName^).getString()%>^ >"
   ZeidonStringCopy( szWriteBuffer, 1, 0, "   <input name=^zNewFileName^ id=^zNewFileName^ type=^hidden^ value=^<%=vKZXMLPGO.cursor(^Session^).getAttribute(^PrintFileName^).getString()%>^ >", 1, 0, 10001 );
   //:   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 1 )
   WL_QC( vDialog, lFileJSP, szWriteBuffer, "^", 1 );
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            GetVariableFromAttribute( szTempString_12, 0, 'S', 255, vDialogTemp, "Control", "WebPlaceholder", "", 0 );
            ZeidonStringCopy( szPlaceholder, 1, 0, " placeholder=^", 1, 0, 257 );
            ZeidonStringConcat( szPlaceholder, 1, 0, szTempString_12, 1, 0, 257 );
         ...
         { 
            //:   szClass = " class=^" + vDialogTemp.Control.CSS_Class + "^ "
            GetVariableFromAttribute( szTempString_14, 0, 'S', 255, vDialogTemp, "Control", "CSS_Class", "", 0 );
            ZeidonStringCopy( szClass, 1, 0, " class=^", 1, 0, 257 );
      ...
      { 
         ...
         { 
            //:   szHTML5Attr = " " + vDialogTemp.Control.WebHTML5Attribute + " "
            GetVariableFromAttribute( szTempString_15, 0, 'S', 255, vDialogTemp, "Control", "WebHTML5Attribute", "", 0 );
            ZeidonStringCopy( szHTML5Attr, 1, 0, " ", 1, 0, 257 );
            ZeidonStringConcat( szHTML5Attr, 1, 0, szTempString_15, 1, 0, 257 );
            ZeidonStringConcat( szHTML5Attr, 1, 0, " ", 1, 0, 257 );
         } 
                           ...
                           zLONG     lOffsetY )
{
   ...
   { 
      ...
      { 
         ...
         //:                   szEntityName + "^ ).checkExistenceOfEntity( ).toInt() >= 0 )"
         ...
         { 
            ...
            //:   WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
            WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
            //:   szWriteBuffer = "            if ( = v" + szCtrlTag +
            //:                ".cursor( ^" + vDialog.CtrlMapRelatedEntity.Name + "^ ).checkExistenceOfEntity( ).toInt() >= 0 )"
            ZeidonStringCopy( szWriteBuffer, 1, 0, "            if ( = v", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
                        ...
                        zPCHAR    szRepeatGrpKey )
{
   ...
   { 
      ...
      //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
      //:szWriteBuffer = "         if ( " + vDialog.CtrlMapView.Name + ".cursor( ^" +
      //:                vDialog.CtrlMapRelatedEntity.Name + "^ ).checkExistenceOfEntity( ).toInt() >= 0 )"
      ...
      //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
      //:// KJS 09/22/25 - trying to take out unnecessary lines
      ...
      GetVariableFromAttribute( szTempString_10, 0, 'S', 255, vDialog, "Control", "Text", "", 0 );
      ZeidonStringCopy( szWriteBuffer, 1, 0, "         strErrorMapValue = ^", 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_10, 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, "^;", 1, 0, 10001 );
      //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
   ...
   { 
      //:szClass = "class=^" + vDialog.Control.CSS_Class + "^ "
      GetVariableFromAttribute( szTempString_11, 0, 'S', 255, vDialog, "Control", "CSS_Class", "", 0 );
      ZeidonStringCopy( szClass, 1, 0, "class=^", 1, 0, 257 );
      ZeidonStringConcat( szClass, 1, 0, szTempString_11, 1, 0, 257 );
      ZeidonStringConcat( szClass, 1, 0, "^ ", 1, 0, 257 );
   } 
   ...
   { 
      //:szHTML5Attr = " " + vDialog.Control.WebHTML5Attribute + " "
      GetVariableFromAttribute( szTempString_12, 0, 'S', 255, vDialog, "Control", "WebHTML5Attribute", "", 0 );
      ZeidonStringCopy( szHTML5Attr, 1, 0, " ", 1, 0, 257 );
      ZeidonStringConcat( szHTML5Attr, 1, 0, szTempString_12, 1, 0, 257 );
      ZeidonStringConcat( szHTML5Attr, 1, 0, " ", 1, 0, 257 );
   } 
   ...
   { 
      ...
      //:END
      //:szWriteBuffer = szWidget + szCtrlTag + szRepeatGrpKey + "^ id=^" + szCtrlTag + szRepeatGrpKey + "^" + szStyle + " ><a href=^<%=strErrorMapValue%>^ target=^_blank^>" + 
      //:                szText + "</a></button>"    
   ...
   { 
      ...
      { 
         ...
         CreateSizeString( vDialog, szSize );
         //:szWriteBuffer = szWidget + szCtrlTag + szRepeatGrpKey + "^ id=^" + szCtrlTag + szRepeatGrpKey + "^ value=^" + szText + "^ onclick=^" +
                    ...
                    zPCHAR    szRepeatGrpKey )
{
   ...
   { 
      ...
      //:// KJS 04/27/26 - Formerly, if the user added a class for the MLE, we did not add
      //:// mceSimple class. But I don't think people realze this is necessary for the tinymce
      //:// to initialze properly. So I think we should always add it.
      //:/*
      //:szClass = vDialog.Control.CSS_Class
      //:IF szClass = ""
      //:   GetViewByName( vLPLR, "TaskLPLR", vDialog, zLEVEL_TASK )
      ...
      //:END
      //:IF vDialog.Control.CSS_Class != "" AND szClass != ""
      if ( CompareAttributeToString( vDialog, "Control", "CSS_Class", "" ) != 0 && ZeidonStringCompare( szClass, 1, 0, "", 1, 0, 257 ) != 0 )
      { 
         //:szClass = szClass + " "
         ZeidonStringConcat( szClass, 1, 0, " ", 1, 0, 257 );
      ...
      { 
         //:szClass = szClass + vDialog.Control.CSS_Class
         GetVariableFromAttribute( szTempString_15, 0, 'S', 255, vDialog, "Control", "CSS_Class", "", 0 );
         ZeidonStringConcat( szClass, 1, 0, szTempString_15, 1, 0, 257 );
      } 
   ...
   { 
      ...
      { 
         ...
         GetVariableFromAttribute( szClass, 0, 'S', 257, vDialog, "Control", "CSS_Class", "", 0 );
         //:szClass = " class=^" + vDialog.Control.CSS_Class + "^"
         GetVariableFromAttribute( szTempString_16, 0, 'S', 255, vDialog, "Control", "CSS_Class", "", 0 );
         ZeidonStringCopy( szClass, 1, 0, " class=^", 1, 0, 257 );
         ZeidonStringConcat( szClass, 1, 0, szTempString_16, 1, 0, 257 );
         ZeidonStringConcat( szClass, 1, 0, "^", 1, 0, 257 );
      } 
                 ...
                 zLONG     lOffsetY )
{
   ...
   { 
      ...
      ZeidonStringCopy( szHTML5Attr, 1, 0, " ", 1, 0, 266 );
      ZeidonStringConcat( szHTML5Attr, 1, 0, szTempString_2, 1, 0, 266 );
   ...
   { 
      ...
      ZeidonStringConcat( szText, 1, 0, szTempString_3, 1, 0, 257 );
   ...
   { 
      ...
      { 
         //:szWriteBuffer = szActionName + "<img src=^<%=strErrorMapValue%>^ name=^" + szCtrlTag + "^ id=^" + szCtrlTag + "^ " + szStyle + szHTML5Attr + szTitleHTML + szClass + szText + ">"
      ...
      { 
         //:szWriteBuffer = szActionName + "<object data=^<%=strErrorMapValue%>^ name=^" + szCtrlTag + "^ id=^" + szCtrlTag + "^ " + szStyle + szHTML5Attr  + szTitleHTML + szClass + szText + "></object>"
         ZeidonStringCopy( szWriteBuffer, 1, 0, szActionName, 1, 0, 10001 );
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            //:                  szStyle + szHTML5Attr + szTitleHTML + szClass + szText + ">"
            ZeidonStringCopy( szWriteBuffer, 1, 0, szActionName, 1, 0, 10001 );
         ...
         { 
            ...
            //:                szStyle + szHTML5Attr + szTitleHTML + szClass + szText + "></object>"
            ZeidonStringCopy( szWriteBuffer, 1, 0, szActionName, 1, 0, 10001 );
                  ...
                  zPCHAR    szRepeatGrpKey )
{
   ...
   //:STRING ( 256 ) szBootstrap5Class1
   zCHAR     szBootstrap5Class1[ 257 ] = { 0 }; 
   //:STRING ( 256 ) szBootstrap5Class2
   zCHAR     szBootstrap5Class2[ 257 ] = { 0 }; 
   //:STRING ( 1 )   szIsLabel
   zCHAR     szIsLabel[ 2 ] = { 0 }; 
   ...
   //:STRING ( 1 )   szBootstrap5
   zCHAR     szBootstrap5[ 2 ] = { 0 }; 
   //:STRING ( 1 )   szBootstrap5Style
   zCHAR     szBootstrap5Style[ 2 ] = { 0 }; 
   ...
   //:END 
   //:// KSJ 06/11/26 - Had been using bootstrap 4 at GMC, now using bootstrap5. This requires jsp changes.
   //:szBootstrap5 = vWork.Root.Bootstrap5
   GetVariableFromAttribute( szBootstrap5, 0, 'S', 2, vWork, "Root", "Bootstrap5", "", 0 );
   ...
   //:szBootstrap5Style = ""
   ZeidonStringCopy( szBootstrap5Style, 1, 0, "", 1, 0, 2 );
   ...
   { 
      ...
      { 
         ...
         //:END  
         //:// KJS 06/11/26 - Is this where I should put logic for the two div classes in bootstrap5
         //:IF szBootstrap5 = "Y" AND ZeidonStringFind( szClassHTML, 1, "input-group" ) > 0 AND ZeidonStringFind( szClassHTML, 1, "input-group-sm" ) > 0
         lTempInteger_1 = ZeidonStringFind( szClassHTML, 1, "input-group" );
         lTempInteger_2 = ZeidonStringFind( szClassHTML, 1, "input-group-sm" );
         if ( ZeidonStringCompare( szBootstrap5, 1, 0, "Y", 1, 0, 2 ) == 0 && lTempInteger_1 > 0 && lTempInteger_2 > 0 )
         { 
            //:TraceLineS("HERE", "HERE")
            TraceLineS( "HERE", "HERE" );
            //:// We assume that input-group is always first?
            //:nPosition = ZeidonStringFind( szClassHTML, 1, "input-group-sm" )
            nPosition = ZeidonStringFind( szClassHTML, 1, "input-group-sm" );
            //:nPosition = nPosition + 14
            nPosition = nPosition + 14;
            //:szBootstrap5Class2 = szClassHTML[nPosition:254]
            ZeidonStringCopy( szBootstrap5Class2, 1, 0, szClassHTML, nPosition, 254, 257 );
            //:szBootstrap5Class1 = "input-group input-group-sm"
            ZeidonStringCopy( szBootstrap5Class1, 1, 0, "input-group input-group-sm", 1, 0, 257 );
            //:szBootstrap5Style = "Y"
            ZeidonStringCopy( szBootstrap5Style, 1, 0, "Y", 1, 0, 2 );
         } 
      ...
      { 
         ...
         { 
            ...
            lTempInteger_3 = CheckExistenceOfEntity( vDialog, "CtrlMapER_Domain" );
            //:( vDialog.CtrlMapER_Domain.DataType = "M" OR vDialog.CtrlMapER_Domain.DataType = "L" )
            if ( ZeidonStringCompare( szStyleIsBootstrap, 1, 0, "Y", 1, 0, 2 ) == 0 && ZeidonStringCompare( szLabelFor, 1, 0, "", 1, 0, 257 ) == 0 && lTempInteger_3 == 0 &&
            ...
            { 
               ...
               { 
                  //:szText = " text-end"
                  ZeidonStringCopy( szText, 1, 0, " text-end", 1, 0, 1001 );
                  //:ELSE
               } 
               else
               { 
         ...
         { 
            ...
            //:( vDialog.CtrlMapER_Domain.DataType = "M" OR vDialog.CtrlMapER_Domain.DataType = "L" )
            if ( ZeidonStringCompare( szStyleIsBootstrap, 1, 0, "Y", 1, 0, 2 ) == 0 && ZeidonStringCompare( szLabelFor, 1, 0, "", 1, 0, 257 ) == 0 && lTempInteger_4 == 0 &&
                 ( CompareAttributeToString( vDialog, "CtrlMapER_Domain", "DataType", "M" ) == 0 || CompareAttributeToString( vDialog, "CtrlMapER_Domain", "DataType", "L" ) == 0 ) )
            { 
               //:IF szBootstrap5 = "Y"
               if ( ZeidonStringCompare( szBootstrap5, 1, 0, "Y", 1, 0, 2 ) == 0 )
   ...
   //:IF szStyleIsBootstrap = "Y" AND szLabelFor != "" AND szBootstrapNoWrap = "" AND szBootstrap5 = "" AND szBootstrap5Style = ""
   if ( ZeidonStringCompare( szStyleIsBootstrap, 1, 0, "Y", 1, 0, 2 ) == 0 && ZeidonStringCompare( szLabelFor, 1, 0, "", 1, 0, 257 ) != 0 && ZeidonStringCompare( szBootstrapNoWrap, 1, 0, "", 1, 0, 2 ) == 0 &&
        ZeidonStringCompare( szBootstrap5, 1, 0, "", 1, 0, 2 ) == 0 && ZeidonStringCompare( szBootstrap5Style, 1, 0, "", 1, 0, 2 ) == 0 )
   { 
   ...
   //:END
   //:/*
   //:IF szStyleIsBootstrap = "Y" AND szLabelFor != "" AND szBootstrapNoWrap = "" AND szBootstrap5 = "Y" AND szBootstrap5Style = "Y"
   //:   szWriteBuffer = "<div class=^" + szBootstrap5Class2 + "^>"
   //:   WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
   //:   szWriteBuffer = "<div class=^" + szBootstrap5Class1 + "^>"
   //:   WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
   //:END
   //:*/
   ...
   lTempInteger_6 = CheckExistenceOfEntity( vDialog, "EventAct" );
   if ( lTempInteger_6 == 0 )
   { 
      //:IF vDialog.EventAct.Type = 45    // Type 45 is Hyperlink Action.
      if ( CompareAttributeToInteger( vDialog, "EventAct", "Type", 45 ) == 0 )
      { 
         ...
         { 
            ...
            GetIntegerFromAttribute( &lTempInteger_8, vDialog, "EventAct", "ZKey" );
            RESULT = SetCursorFirstEntityByInteger( vDialogRoot, "Action", "ZKey", lTempInteger_8, "" );
   ...
   //:IF szStyleIsBootstrap = "Y" AND szLabelFor != "" AND szBootstrapNoWrap = "" AND szBootstrap5 = ""
   if ( ZeidonStringCompare( szStyleIsBootstrap, 1, 0, "Y", 1, 0, 2 ) == 0 && ZeidonStringCompare( szLabelFor, 1, 0, "", 1, 0, 257 ) != 0 && ZeidonStringCompare( szBootstrapNoWrap, 1, 0, "", 1, 0, 2 ) == 0 &&
        ZeidonStringCompare( szBootstrap5, 1, 0, "", 1, 0, 2 ) == 0 )
   { 
      //:szWriteBuffer = "</div>"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "</div>", 1, 0, 10001 );
      //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
                     ...
                     zPCHAR    szRepeatGrpKey )
{
   ...
   { 
      ...
      //:// at "internal value"? 
      //:// KJS 12/09/21 - At HFI, they have several "date" fields that are edit controls with disable checked (which is excluded from input mapping). Need
      //:// to allow the default context in this case.
      //:IF szContextName = ""
      if ( ZeidonStringCompare( szContextName, 1, 0, "", 1, 0, 33 ) == 0 )
      { 
         //:lSubtype = vDialog.Control.Subtype
         GetIntegerFromAttribute( &lSubtype, vDialog, "Control", "Subtype" );
         ...
         if ( lTemp != 0 )
         { 
            //:// Disabled edit boxes will use default context.
            //:szWriteBuffer = "               strErrorMapValue = " +
            //:                vDialog.CtrlMapView.Name + ".cursor( ^" +
            //:                vDialog.CtrlMapRelatedEntity.Name + "^ ).getAttribute( ^" +
            //:                vDialog.CtrlMapER_Attribute.Name + "^ ).getString( ^^ );"
      ...
      { 
         ...
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_12, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getAttribute( ^", 1, 0, 10001 );
         GetVariableFromAttribute( szTempString_13, 0, 'S', 33, vDialog, "CtrlMapER_Attribute", "Name", "", 0 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_13, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getString( ^", 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szContextName, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, "^ );", 1, 0, 10001 );
      ...
      { 
         ...
         WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
         //:szWriteBuffer = "         strErrorMapValue = ^" + vDialog.Control.Text + "^;"
         GetVariableFromAttribute( szTempString_17, 0, 'S', 255, vDialog, "Control", "Text", "", 0 );
         ZeidonStringCopy( szWriteBuffer, 1, 0, "         strErrorMapValue = ^", 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_17, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, "^;", 1, 0, 10001 );
      } 
   ...
   { 
      ...
      { 
         ...
         GetVariableFromAttribute( szTempString_18, 0, 'S', 255, vDialog, "Control", "Text", "", 0 );
         ZeidonStringCopy( szValue, 1, 0, " value=^", 1, 0, 301 );
         ZeidonStringConcat( szValue, 1, 0, szTempString_18, 1, 0, 301 );
   ...
   { 
      ...
      { 
         //:szValue = " value=^" + vDialog.Control.Text + "^"
         GetVariableFromAttribute( szTempString_19, 0, 'S', 255, vDialog, "Control", "Text", "", 0 );
         ZeidonStringCopy( szValue, 1, 0, " value=^", 1, 0, 301 );
         ZeidonStringConcat( szValue, 1, 0, szTempString_19, 1, 0, 301 );
         ZeidonStringConcat( szValue, 1, 0, "^", 1, 0, 301 );
         //:ELSE
      } 
      else
   ...
   { 
      ...
      GetVariableFromAttribute( szTempString_20, 0, 'S', 255, vDialog, "Control", "WebPlaceholder", "", 0 );
      ZeidonStringCopy( szPlaceholder, 1, 0, " placeholder=^", 1, 0, 257 );
      ZeidonStringConcat( szPlaceholder, 1, 0, szTempString_20, 1, 0, 257 );
      ZeidonStringConcat( szPlaceholder, 1, 0, "^ ", 1, 0, 257 );
   } 
   ...
   { 
      //:szHTML5Attr = " " + vDialog.Control.WebHTML5Attribute + " "
      GetVariableFromAttribute( szTempString_21, 0, 'S', 255, vDialog, "Control", "WebHTML5Attribute", "", 0 );
      ZeidonStringCopy( szHTML5Attr, 1, 0, " ", 1, 0, 257 );
      ZeidonStringConcat( szHTML5Attr, 1, 0, szTempString_21, 1, 0, 257 );
      ZeidonStringConcat( szHTML5Attr, 1, 0, " ", 1, 0, 257 );
   } 
   ...
   { 
      ...
      GetVariableFromAttribute( szTempString_22, 0, 'S', 255, vDialog, "Control", "CSS_Class", "", 0 );
      ZeidonStringConcat( szClass, 1, 0, szTempString_22, 1, 0, 257 );
      ZeidonStringConcat( szClass, 1, 0, "^ ", 1, 0, 257 );
   } 
                        ...
                        zPCHAR    szRepeatGrpKey )
{
   ...
   { 
      ...
      { 
         ...
         if ( ZeidonStringCompare( szRepeatGrpKey, 1, 0, "", 1, 0, 101 ) == 0 )
         { 
            //:szWriteBuffer = szWriteBuffer + "^ <%=strErrorMapValue%> " + szStyle + szDisabled + " onclick=^" + szActionName + "( )^  ></td>"
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ <%=strErrorMapValue%> ", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szStyle, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szDisabled, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, " onclick=^", 1, 0, 10001 );
         ...
         { 
            //:szWriteBuffer = szWriteBuffer + "^ <%=strErrorMapValue%> " + szStyle + szDisabled + " onclick=^" + szActionName + "( '" + szCtrlTag + szRepeatGrpKey + "' )^  ></td>"
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ <%=strErrorMapValue%> ", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szStyle, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szDisabled, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, " onclick=^", 1, 0, 10001 );
                      ...
                      zPCHAR    szRepeatGrpKey )
{
   ...
   //:STRING ( 1 )   szBootstrap5
   zCHAR     szBootstrap5[ 2 ] = { 0 }; 
   //:STRING ( 1 )   szAutoIncludeComboBlank
   zCHAR     szAutoIncludeComboBlank[ 2 ] = { 0 }; 
   //:STRING ( 64 )  szSystemIniApplName
   zCHAR     szSystemIniApplName[ 65 ] = { 0 }; 
   //:STRING ( 20 )  szCSSBootstrap
   zCHAR     szCSSBootstrap[ 21 ] = { 0 }; 
   ...
   if ( CompareAttributeToString( vDialog, "Control", "CSS_Class", "" ) != 0 || ZeidonStringCompare( szStyleIsBootstrap, 1, 0, "Y", 1, 0, 2 ) == 0 )
   { 
      //:IF szStyleIsBootstrap = "Y" AND szBootstrap5 = ""
      if ( ZeidonStringCompare( szStyleIsBootstrap, 1, 0, "Y", 1, 0, 2 ) == 0 && ZeidonStringCompare( szBootstrap5, 1, 0, "", 1, 0, 2 ) == 0 )
      { 
         //:szCSSBootstrap = "form-control "
         ZeidonStringCopy( szCSSBootstrap, 1, 0, "form-control ", 1, 0, 21 );
         //:ELSE
      ...
      { 
         //:IF szStyleIsBootstrap = "Y" AND szBootstrap5 = "Y"
         if ( ZeidonStringCompare( szStyleIsBootstrap, 1, 0, "Y", 1, 0, 2 ) == 0 && ZeidonStringCompare( szBootstrap5, 1, 0, "Y", 1, 0, 2 ) == 0 )
         { 
            //:szCSSBootstrap = "form-select "
            ZeidonStringCopy( szCSSBootstrap, 1, 0, "form-select ", 1, 0, 21 );
            //:ELSE
         } 
         else
         { 
   ...
   { 
      ...
      { 
         ...
         { 
            ...
            //:// KJS 05/29/25 - I added a special jspWebUtilsLang for our language translation.
            //:// But now I know how to do this by adding code into our DynamicDomain code using the regular call.
            //:// I'm going to comment out and see.
            //://IF vDialogRoot.Dialog.wWebUsesLanguageConversion = "Y" 
            //://   GetViewByName( vLPLR, "TaskLPLR", vDialog, zLEVEL_TASK )
            //://   szJavaPackage = vLPLR.LPLR.JavaPackageName
            //://   zSearchAndReplace( szJavaPackage, 100, "\", "." )
            //://   szWriteBuffer = "      List<TableEntry> list = " + szJavaPackage + ".jspWebUtilsLang.getTableDomainValuesLanguage( " + vDialog.CtrlMapView.Name + " , ^" +
            ...
            //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
            WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
            //:szWriteBuffer = "         strComboCurrentInternalValue = " + vDialog.CtrlMapView.Name + ".cursor( ^" +
            //:         vDialog.CtrlMapRelatedEntity.Name + "^ ).getAttribute( ^" +
            //:         vDialog.CtrlMapER_Attribute.Name + "^ ).getString( );"
            GetVariableFromAttribute( szTempString_16, 0, 'S', 33, vDialog, "CtrlMapView", "Name", "", 0 );
            ZeidonStringCopy( szWriteBuffer, 1, 0, "         strComboCurrentInternalValue = ", 1, 0, 10001 );
            ...
            //:szWriteBuffer = "         if ( !StringUtils.isBlank( internalValue ) )"
            ZeidonStringCopy( szWriteBuffer, 1, 0, "         if ( !StringUtils.isBlank( internalValue ) )", 1, 0, 10001 );
            //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
            WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
            //:szWriteBuffer = "         {"
            ZeidonStringCopy( szWriteBuffer, 1, 0, "         {", 1, 0, 10001 );
            ...
            //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
            WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
            //://szWriteBuffer = "               strComboCurrentInternalValue = internalValue;"
            //://WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
            ...
            //:szWriteBuffer = "         <option disabled selected=^selected^ value=^<%=strComboCurrentInternalValue%>^><%=strComboCurrentValue%></option>"
            ZeidonStringCopy( szWriteBuffer, 1, 0, "         <option disabled selected=^selected^ value=^<%=strComboCurrentInternalValue%>^><%=strComboCurrentValue%></option>", 1, 0, 10001 );
            //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
            WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
            //:szWriteBuffer = "<%"
            ZeidonStringCopy( szWriteBuffer, 1, 0, "<%", 1, 0, 10001 );
      ...
      //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 1 )
      WL_QC( vDialog, lFile, szWriteBuffer, "^", 1 );
      //:szWriteBuffer = "<input name=^h" + szCtrlTag + szRepeatGrpKey + "^ id=^h" + szCtrlTag + szRepeatGrpKey + "^ type=^hidden^ value=^<%=strComboCurrentInternalValue%>^ >"
      ZeidonStringCopy( szWriteBuffer, 1, 0, "<input name=^h", 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, szRepeatGrpKey, 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, "^ id=^h", 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, szRepeatGrpKey, 1, 0, 10001 );
      ZeidonStringConcat( szWriteBuffer, 1, 0, "^ type=^hidden^ value=^<%=strComboCurrentInternalValue%>^ >", 1, 0, 10001 );
      //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
      WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
   ...
   { 
      ...
      { 
         ...
         ZeidonStringConcat( szWriteBuffer, 1, 0, " = ", 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, "task.getViewByName( ^", 1, 0, 10001 );
         GetVariableFromAttribute( szTempString_20, 0, 'S', 33, vList, "CtrlMapView", "Name", "", 0 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_20, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, "^ );", 1, 0, 10001 );
         //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
         WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
         //:szWriteBuffer = "   if ( VmlOperation.isValid( " + vList.CtrlMapView.Name + " ) )"
         GetVariableFromAttribute( szTempString_21, 0, 'S', 33, vList, "CtrlMapView", "Name", "", 0 );
         ZeidonStringCopy( szWriteBuffer, 1, 0, "   if ( VmlOperation.isValid( ", 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_21, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, " ) )", 1, 0, 10001 );
         //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
         ...
         { 
            ...
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_25, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_26, 0, 'S', 33, vDialog, "CtrlMapRelatedEntity", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_26, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).checkExistenceOfEntity( ).toInt() >= 0 )", 1, 0, 10001 );
            //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
            WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
            ...
            //:END
            //:// Get the internal value of the 
            //:szWriteBuffer = "            strComboCurrentValue = " + vDialog.CtrlMapView.Name + ".cursor( ^" +
            //:         vDialog.CtrlMapRelatedEntity.Name + "^ ).getAttribute( ^" +
            //:         vDialog.CtrlMapER_Attribute.Name + "^ ).getString( );"
            GetVariableFromAttribute( szTempString_27, 0, 'S', 33, vDialog, "CtrlMapView", "Name", "", 0 );
            ZeidonStringCopy( szWriteBuffer, 1, 0, "            strComboCurrentValue = ", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_27, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_28, 0, 'S', 33, vDialog, "CtrlMapRelatedEntity", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_28, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getAttribute( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_29, 0, 'S', 33, vDialog, "CtrlMapER_Attribute", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_29, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getString( );", 1, 0, 10001 );
            //:         //vDialog.CtrlMapER_Attribute.Name + "^ ).getString( ^" + szContextName + "^ );"
            //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
         ...
         { 
            ...
            { 
               //:szScopingEntityName = "^" + vScope.CtrlMapLOD_Entity.Name + "^"
               GetVariableFromAttribute( szTempString_30, 0, 'S', 33, vScope, "CtrlMapLOD_Entity", "Name", "", 0 );
               ZeidonStringCopy( szScopingEntityName, 1, 0, "^", 1, 0, 33 );
               ZeidonStringConcat( szScopingEntityName, 1, 0, szTempString_30, 1, 0, 33 );
               ZeidonStringConcat( szScopingEntityName, 1, 0, "^", 1, 0, 33 );
               //:ELSE
            } 
            else
         ...
         GetViewByName( &vLPLR, "TaskLPLR", vDialog, zLEVEL_TASK );
         //:szSystemIniApplName = "[App." + vLPLR.LPLR.Name + "]"
         GetVariableFromAttribute( szTempString_31, 0, 'S', 33, vLPLR, "LPLR", "Name", "", 0 );
         ZeidonStringCopy( szSystemIniApplName, 1, 0, "[App.", 1, 0, 65 );
         ZeidonStringConcat( szSystemIniApplName, 1, 0, szTempString_31, 1, 0, 65 );
         ZeidonStringConcat( szSystemIniApplName, 1, 0, "]", 1, 0, 65 );
         //:SysReadZeidonIni( -1, szSystemIniApplName, "AutoIncludeComboBlank", szAutoIncludeComboBlank )
         SysReadZeidonIni( -1, szSystemIniApplName, "AutoIncludeComboBlank", szAutoIncludeComboBlank, zsizeof( szAutoIncludeComboBlank ) );

         //:szWriteBuffer = "      v" + szCtrlTag + " = " + vList.CtrlMapView.Name + ".newView( );"
         ZeidonStringCopy( szWriteBuffer, 1, 0, "      v", 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, " = ", 1, 0, 10001 );
         GetVariableFromAttribute( szTempString_32, 0, 'S', 33, vList, "CtrlMapView", "Name", "", 0 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_32, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, ".newView( );", 1, 0, 10001 );
         //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
         WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
         ...
         { 
            ...
            //://szWriteBuffer = "      ComboCount++;"
            //://WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
            //:// Check the first line is blank and don't add if it is.
            ...
            { 
               ...
               ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
               //:IF szScopingEntityName = ""
               if ( ZeidonStringCompare( szScopingEntityName, 1, 0, "", 1, 0, 33 ) == 0 )
               { 
                  //:szWriteBuffer = szWriteBuffer + szListEntityName + "^ ).setFirst().isSet() && v"
                  ZeidonStringConcat( szWriteBuffer, 1, 0, szListEntityName, 1, 0, 10001 );
                  ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).setFirst().isSet() && v", 1, 0, 10001 );
                  //:ELSE
               } 
               else
               { 
                  //:szWriteBuffer = szWriteBuffer + szListEntityName + "^ ).setFirst( " + szScopingEntityName + " ).isSet() && v"
                  ZeidonStringConcat( szWriteBuffer, 1, 0, szListEntityName, 1, 0, 10001 );
                  ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).setFirst( ", 1, 0, 10001 );
                  ZeidonStringConcat( szWriteBuffer, 1, 0, szScopingEntityName, 1, 0, 10001 );
                  ZeidonStringConcat( szWriteBuffer, 1, 0, " ).isSet() && v", 1, 0, 10001 );
               } 

               //:END

               //:// KJS 07/08/25 - Adding a check for null because it sometimes fails here.
               //:szWriteBuffer = szWriteBuffer + szCtrlTag + ".cursor( ^" + szListEntityName + "^ ).getAttribute( ^" +
               //:                vList.CtrlMapER_Attribute.Name + "^ ).getString(^^)!= null && v"
               ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, szListEntityName, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getAttribute( ^", 1, 0, 10001 );
               GetVariableFromAttribute( szTempString_33, 0, 'S', 33, vList, "CtrlMapER_Attribute", "Name", "", 0 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_33, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getString(^^)!= null && v", 1, 0, 10001 );
               //:szWriteBuffer = szWriteBuffer + szCtrlTag + ".cursor( ^" + szListEntityName + "^ ).getAttribute( ^" +
               //:                vList.CtrlMapER_Attribute.Name + "^ ).getString(^^).length() > 0 )"
               ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, szListEntityName, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getAttribute( ^", 1, 0, 10001 );
               GetVariableFromAttribute( szTempString_34, 0, 'S', 33, vList, "CtrlMapER_Attribute", "Name", "", 0 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_34, 1, 0, 10001 );
               ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getString(^^).length() > 0 )", 1, 0, 10001 );
               //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
               WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
               //:                        
               //:szWriteBuffer = "      {"
            ...
            //:END
            //://if ( vcbRefHFIClient.cursor( "HFIClient" ).setFirst(  ).isSet() && 
            //://     vcbRefHFIClient.cursor( "HFIClient" ).getAttribute( "ClientName" ).getString( "" ).length() > 0 )
            //:szWriteBuffer = "      ComboCount++;"
            ZeidonStringCopy( szWriteBuffer, 1, 0, "      ComboCount++;", 1, 0, 10001 );
            //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
            WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
         ...
         { 
            ...
            ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_35, 0, 'S', 33, vList, "CtrlMapRelatedEntity", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_35, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getAttribute( ^", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_36, 0, 'S', 33, vList, "CtrlMapER_Attribute", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_36, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getString( ^", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szContextName, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ );", 1, 0, 10001 );
         ...
         //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
         WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
         //:szWriteBuffer = "         if ( StringUtils.equals( strComboCurrentValue, v" + szCtrlTag + ".cursor( ^" +
         //:                   vList.CtrlMapRelatedEntity.Name + "^ ).getAttribute( ^" +
         //:                   vList.CtrlMapER_Attribute.Name + "^ ).getString( ) ) )"
         ZeidonStringCopy( szWriteBuffer, 1, 0, "         if ( StringUtils.equals( strComboCurrentValue, v", 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, ".cursor( ^", 1, 0, 10001 );
         GetVariableFromAttribute( szTempString_37, 0, 'S', 33, vList, "CtrlMapRelatedEntity", "Name", "", 0 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_37, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getAttribute( ^", 1, 0, 10001 );
         GetVariableFromAttribute( szTempString_38, 0, 'S', 33, vList, "CtrlMapER_Attribute", "Name", "", 0 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_38, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, "^ ).getString( ) ) )", 1, 0, 10001 );
         //:WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 )
         WL_QC( vDialog, lFile, szWriteBuffer, "^", 0 );
                      ...
                      zPCHAR    szRepeatGrpKey )
{
   ...
   { 
      ...
      if ( ZeidonStringCompare( szRepeatGrpKey, 1, 0, "", 1, 0, 101 ) == 0 )
      { 
         //:szWriteBuffer = szWriteBuffer + "^ <%=strErrorMapValue%> " + szTitleHTML + szStyle + " onclick=^" + vDialog.EventAct.Tag + "( )^>"
         ZeidonStringConcat( szWriteBuffer, 1, 0, "^ <%=strErrorMapValue%> ", 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTitleHTML, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szStyle, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, " onclick=^", 1, 0, 10001 );
      ...
      { 
         //:szWriteBuffer = szWriteBuffer + "^ <%=strErrorMapValue%> " + szTitleHTML + szStyle + " onclick=^" + vDialog.EventAct.Tag + "( '" + szCtrlTag + szRepeatGrpKey + "' )^>"
         ZeidonStringConcat( szWriteBuffer, 1, 0, "^ <%=strErrorMapValue%> ", 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szTitleHTML, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, szStyle, 1, 0, 10001 );
         ZeidonStringConcat( szWriteBuffer, 1, 0, " onclick=^", 1, 0, 10001 );
                      ...
                      zPCHAR    szRepeatGrpKey )
{
   ...
   { 
      ...
      { 
         //:szPlaceholder = " placeholder=^" + vDialog.Control.WebPlaceholder + "^ "
         GetVariableFromAttribute( szTempString_14, 0, 'S', 255, vDialog, "Control", "WebPlaceholder", "", 0 );
         ZeidonStringCopy( szPlaceholder, 1, 0, " placeholder=^", 1, 0, 257 );
         ZeidonStringConcat( szPlaceholder, 1, 0, szTempString_14, 1, 0, 257 );
         ZeidonStringConcat( szPlaceholder, 1, 0, "^ ", 1, 0, 257 );
      } 
      ...
      { 
         //:szHTML5Attr = " " + vDialog.Control.WebHTML5Attribute + " "
         GetVariableFromAttribute( szTempString_15, 0, 'S', 255, vDialog, "Control", "WebHTML5Attribute", "", 0 );
         ZeidonStringCopy( szHTML5Attr, 1, 0, " ", 1, 0, 266 );
         ZeidonStringConcat( szHTML5Attr, 1, 0, szTempString_15, 1, 0, 266 );
         ZeidonStringConcat( szHTML5Attr, 1, 0, " ", 1, 0, 266 );
      } 
      ...
      { 
         ...
         { 
            ...
            //:                    szAutoCompleteOff + szTitleHTML + szHTML5Attr + szPlaceholder + szActionCode + szStyleCalendar + " type=^text^ value=^<%=strErrorMapValue%>^ " + szTabIndex + szKeyPressCode + " />"
            ZeidonStringCopy( szWriteBuffer, 1, 0, "   <input name=^", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szCtrlTag, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szRepeatGrpKey, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "^ id=^", 1, 0, 10001 );
         ...
         { 
            ...
            ZeidonStringConcat( szWriteBuffer, 1, 0, szRepeatGrpKey, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "' ), this, '", 1, 0, 10001 );
            GetVariableFromAttribute( szTempString_16, 0, 'S', 33, vDialog, "CtrlMapContext", "Name", "", 0 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTempString_16, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, "' );^ ", 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, szTabIndex, 1, 0, 10001 );
            ZeidonStringConcat( szWriteBuffer, 1, 0, " />", 1, 0, 10001 );
