...
MigrateMeta( zVIEW     vSubtask )
{
   ...
   { 
      ...
      { 
         ...
         MB_SetMessage( vSubtask, 1, MG_ErrorMessage );
         //:nRC = DomainGrpMigrate( NewDomainGroup, MetaName, SourceLPLR, CurrentLPLR, vSubtask )
         nRC = oTZDGSRCO_DomainGrpMigrate( NewDomainGroup, MetaName, SourceLPLR, CurrentLPLR, vSubtask );
         //:IF nRC < 0
         if ( nRC < 0 )
         { 
