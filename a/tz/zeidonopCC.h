...
//start TZWDLGSO 2023.02.20 14:10:44
zOPER_EXPORT zSHORT OPERATION
oTZWDLGSO_ConvertListBoxToGrid( zVIEW vViewToInstance0 );

zOPER_EXPORT zSHORT OPERATION
oTZWDLGSO_CloneControl( zVIEW vViewToInstance0,
                        zVIEW vSourceLPLR21,
                        zVIEW vOrigW2,
                        zVIEW vOrigWC3,
                        zVIEW vNewW4,
...
zOPER_EXPORT zSHORT OPERATION
oTZWDLGSO_GenerateJSPJavaInc( zVIEW vViewToInstance0,
                              zVIEW vvSubtask1 );

zOPER_EXPORT zSHORT OPERATION
oTZWDLGSO_FixCtrlCtrlAttributes( zVIEW vvDialog0,
                                 zVIEW vvSubtask1 );

zOPER_EXPORT zSHORT OPERATION
oTZWDLGSO_GenJSPJ_ProcessFileIn( zVIEW vViewToInstance0,
                                 zPCHAR pchszAppendDateTime1,
                                 zLONG llFileJSP2,
                                 zPCHAR pchszWriteBuffer3 );

//end
//start TZWDGRWO 2023.02.20 14:10:42
zOPER_EXPORT zSHORT OPERATION
...
//end
//start TZTENVRO 2023.02.20 14:10:40
zOPER_EXPORT zSHORT OPERATION
...
zOPER_EXPORT zSHORT OPERATION
oTZTENVRO_RebuildDBMS_Tables( zVIEW vViewToInstance0,
                              zVIEW vERD1,
                              zVIEW vSubtask2,
                              zPCHAR pchStartingEntityName3 );
...
zOPER_EXPORT zSHORT OPERATION
oTZTENVRO_BuildTablRecsFromEMD( zVIEW vViewToInstance0,
                                zVIEW vvDTE1,
                                zVIEW vvEMD2,
                                zPCHAR pchScopingEntityName3 );

zOPER_EXPORT zSHORT OPERATION
oTZTENVRO_BuildRelationsFromEMD( zVIEW vViewToInstance0,
                                 zVIEW vDTE1,
                                 zVIEW vERD2 );

//end
//start TZOGSRCO 2023.02.20 14:10:29
zOPER_EXPORT zSHORT OPERATION
...
zOPER_EXPORT zSHORT OPERATION
oTZOGSRCO_GenerateXOG( zVIEW vViewToInstance0 );

//end
//start TZERSASO 2023.02.20 14:10:28
zOPER_EXPORT zSHORT OPERATION
...
//end
//start TZDGSRCO 2023.02.20 14:10:23
zOPER_EXPORT zSHORT OPERATION
...
//end
//start TZCMREPO 2023.02.20 14:10:19
zOPER_EXPORT zSHORT OPERATION
...
//end
//start TZADCSDO 2023.02.20 14:10:11
zOPER_EXPORT zSHORT OPERATION
...
//start TZCM_OPR 2023.02.24 13:55:25
zOPER_EXPORT zSHORT OPERATION
InitializeNextZKeyForObject( zVIEW vObjectView0,
                             zPCHAR pchRootEntityName1,
                             zPCHAR pchCurrentEntityName2 );

zOPER_EXPORT zSHORT OPERATION
RepaintWindowControls( zVIEW vViewToWindow0 );

zOPER_EXPORT zSHORT OPERATION
SetLODSQL_DBH_X_ToOne( zVIEW vvLOD0 );
...
zOPER_EXPORT zSHORT OPERATION
RebuildXDM( zVIEW vvSubtask0 );

zOPER_EXPORT zSHORT OPERATION
RebuildXODs( zVIEW vvSubtask0 );

zOPER_EXPORT zSHORT OPERATION
RebuildMetaLists( zVIEW vvSubtask0 );
...
//end
//start TZCM_OPR 2015.10.27 15:41:07
zOPER_EXPORT zSHORT OPERATION
InitializeNextZKeyForObject( zVIEW vObjectView0,
                             zPCHAR pchRootEntityName1,
                             zPCHAR pchCurrentEntityName2 );
...
//end
//start TZEREMDO 2023.02.20 14:10:25
zOPER_EXPORT zSHORT OPERATION
...
zOPER_EXPORT zSHORT OPERATION
oTZEREMDO_ConvertZKeyDomains( zVIEW vViewToInstance0 );
...
zOPER_EXPORT zSHORT OPERATION
oTZEREMDO_ERD_Compare( zVIEW vViewToInstance0,
                       zVIEW vSourceERD1,
                       zPCHAR pchszMergeType2 );

zOPER_EXPORT zSHORT OPERATION
oTZEREMDO_ERD_Merge( zVIEW vViewToInstance0,
                     zVIEW vSourceERD1,
                     zVIEW vvSubtask2,
                     zPCHAR pchWholeLPLRFlag3 );

zOPER_EXPORT zSHORT OPERATION
oTZEREMDO_GenerateID_Identifiers( zVIEW vViewToInstance0 );

zOPER_EXPORT zSHORT OPERATION
oTZEREMDO_MergeER_AttrsToLODs( zVIEW vViewToInstance0,
                               zVIEW vTZBRLOVO1 );

zOPER_EXPORT zSHORT OPERATION
oTZEREMDO_MergeER_AttrsRecurs( zVIEW vViewToInstance0,
                               zVIEW vTZBRLOVO1,
                               zVIEW vTZBRLOVO_Temp2,
                               zVIEW vTZZOLODO3,
                               zPCHAR pchLOD_Name4 );
...
//start TZRPSRCO 2023.02.20 14:10:36
zOPER_EXPORT zSHORT OPERATION
...
//start TZ__PRFO 2023.02.20 14:10:10
zOPER_EXPORT zSHORT OPERATION
...
//end
//start TZZOLODO 2023.02.20 14:10:47
zOPER_EXPORT zSHORT OPERATION
...
zOPER_EXPORT zSHORT OPERATION
oTZZOLODO_LOD_CreateER_AttrFrmER( zVIEW vViewToInstance0,
                                  zVIEW vSourceLPLR1,
                                  zVIEW vCurrentLPLR2,
                                  zVIEW vNewERD3,
                                  zVIEW vvSubtask4 );
...
zOPER_EXPORT zSHORT OPERATION
oTZZOLODO_LOD_EntityMerge( zVIEW vViewToInstance0,
                           zVIEW vNewRecursiveLOD1,
                           zVIEW vOldMainLOD2,
                           zVIEW vOldRecursiveLOD3,
                           zVIEW vSourceLPLR24,
...
//end
//start TZTEMPMO 2023.02.20 14:10:39
zOPER_EXPORT zSHORT OPERATION
...
//start TZCMCPRO 2023.02.20 14:10:16
zOPER_EXPORT zSHORT OPERATION
...
//end
//start TZCMLPLO 2023.02.20 14:10:18
zOPER_EXPORT zSHORT OPERATION
...
zOPER_EXPORT zSHORT OPERATION
oTZCMLPLO_CreateErrorMessage( zVIEW vViewToInstance0,
                              zPCHAR pchMessageText1 );
...
zOPER_EXPORT zSHORT OPERATION
oTZCMLPLO_WriteErrorMessagesCSV( zVIEW vViewToInstance0 );
...
//start TZPESRCO 2023.02.20 14:10:32
zOPER_EXPORT zSHORT OPERATION
...
//end
//start KZXMLPGO 2023.02.20 14:10:09
zOPER_EXPORT zSHORT OPERATION
...
//end
//start ACCOUNT 2016.12.22 12:17:35
zOPER_EXPORT zSHORT OPERATION
...
//end
//start TZWEBGL1 2019.11.18 15:55:43
...
//end
//start TZWEBGL2 2019.12.06 17:33:47
zOPER_EXPORT zVOID OPERATION
...
//end
//start TZWEBGL3 2023.01.27 15:11:15
zOPER_EXPORT zSHORT OPERATION
...
zOPER_EXPORT zSHORT OPERATION
GenJSPJ_ActionRecurs( zVIEW vvDialog0,
                      zVIEW vvDialogMenuRoot1,
                      zVIEW vvDialogRoot2,
                      zLONG llFile3,
                      zPCHAR pchszWriteBuffer4,
                      zPCHAR pchszFormName5,
                      zLONG llTraceLevel6,
                      zPCHAR pchszActionPrefix7 );

zOPER_EXPORT zVOID OPERATION
GenJSP_MenuFunctionsRecurs( zVIEW vDialog0,
                            zVIEW vvDialogMenuRoot1,
                            zVIEW vDialogRoot2,
                            zLONG llFile3,
                            zPCHAR pchWriteBuffer4,
                            zPCHAR pchFormName5,
                            zPCHAR pchActionPrefix6 );

zOPER_EXPORT zSHORT OPERATION
BuildMainNavSectionBootstrap( zVIEW vvDialog0,
                              zVIEW vvDialogRoot1,
                              zLONG llFile2,
                              zPCHAR pchSideMenuExistsFlag3 );

zOPER_EXPORT zSHORT OPERATION
GenJSPJ_CrteSideMenuRecurs( zVIEW vvDialog0,
                            zVIEW vvDialogRoot1,
                            zLONG llFile2,
...
//end
//start TZWEBGL4 2022.06.20 11:53:52
zOPER_EXPORT zSHORT OPERATION
...
zOPER_EXPORT zSHORT OPERATION
GenJSPJ_CrteMLEditGrd( zVIEW vvDialog0,
                       zLONG lFile1,
                       zPCHAR pchWriteBuffer2,
                       zPCHAR pchIndent3,
                       zPCHAR pchCtrlTag4,
...
zOPER_EXPORT zVOID OPERATION
GenJSPJ_CrteGridRadio( zVIEW vvDialog0,
                       zLONG llFile1,
                       zPCHAR pchWriteBuffer2,
                       zPCHAR pchIndent3,
                       zPCHAR pchRadioGroupName4,
...
zOPER_EXPORT zSHORT OPERATION
GenJSPJ_CrteFileTransferForm( zVIEW vvDialog0,
                              zVIEW vvDialogRoot1,
                              zLONG lFile2,
                              zPCHAR pchWriteBuffer3,
                              zPCHAR pchIndent4,
                              zPCHAR pchNoPositioning5,
                              zPCHAR pchszStyleIsBootstrap6,
                              zPCHAR pchszBootstrapOuterCard7,
                              zLONG lOffsetX8,
                              zLONG lOffsetY9 );

zOPER_EXPORT zSHORT OPERATION
GenJSPJ_CrteListBoxAsList( zVIEW vvDialog0,
                           zLONG llFile1,
                           zPCHAR pchszWriteBuffer2,
                           zPCHAR pchszIndent3,
                           zPCHAR pchszCtrlTag4,
                           zPCHAR pchszNoPositioning5,
                           zLONG llOffsetX6,
                           zLONG llOffsetY7 );

zOPER_EXPORT zSHORT OPERATION
BuildMenuListJ( zVIEW vvDialog0,
                zVIEW vvDialogRoot1,
                zLONG llFile2,
                zPCHAR pchszMenuName3 );

zOPER_EXPORT zVOID OPERATION
GenJSPJ_CrtePushButton( zVIEW vvDialog0,
                        zVIEW vvGroupParent1,
                        zLONG lFile2,
                        zPCHAR pchWriteBuffer3,
                        zPCHAR pchIndent4,
                        zPCHAR pchCtrlTag5,
                        zPCHAR pchTableRowFlag6,
                        zPCHAR pchJustify7,
                        zPCHAR pchNoPositioning8,
                        zLONG lOffsetX9,
                        zLONG lOffsetY10,
                        zPCHAR pchstrRepeatGrpKey11 );
